...
// A Structure for day,month,year
struct date
{
    int day;
    int month;
...
/**< All possibilities for the dates (leap year) */
date tomorrowsdate(date todaysDate)
{
    ...
    {
        cout << "That's not a real date for that year" << endl;
        return tomorrowsDate;
    }
    /**< if the month has 30days */
    else if(todaysDate.day == 30)
    {
        /**<its te months April, June, Sept and Nov */
